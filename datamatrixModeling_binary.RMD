...
params = list( csvPath=            "datalocation/pyradiomicsout.csv", target=             "MutationalStatusAPC", positive_class=     "mut", inputs=               NULL , leaveOneOut=          TRUE, test_csv=             NULL, rescale=              FALSE, removeCorrelated=     TRUE, plot=                 TRUE, semisupervised=       FALSE, kClusters=            as.numeric(9), genetic=              FALSE, boruta=               TRUE, univariate=           FALSE )
